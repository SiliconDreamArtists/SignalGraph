# ══════════════════════════════════════════════════════════════════════════════
# 📦 FUNCTION: Resolve-InnerPathFromDictionary
...
function Resolve-InnerPathFromDictionary {
    ...
    $opSignal = [Signal]::Start("Resolve-InnerPathFromDictionary", $Dictionary) | Select-Object -Last 1
...
#                        $opSignal.LogVerbose("🧩 Accessed #Grid")
        ...
        if ($null -eq $current -and $HasDefault) {
